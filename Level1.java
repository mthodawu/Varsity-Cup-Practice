...
public class Level1 {
    public static void main(String[] args) {
        ...
        System.out.println("Backpack Capacity: " + backpackCapacity + " Maximum Value: " + maxValue(itemList, backpackCapacity));
    ...
    public static String maxValue(HashMap<String, Item> itemsHashMap, int capacity) {
        ...
        Comparator<HashMap.Entry<String, Item>> valueComparator = Comparator.comparing(entry -> entry.getValue().getValuePerWeight());
